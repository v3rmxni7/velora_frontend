      ...
      <div className="relative mx-auto max-w-3xl px-6 text-center">
        ...
        <Reveal delay={0.12}>
          <div className="mt-8 flex flex-wrap justify-center gap-3">
            ...
            <Link
              href="/login"
              className="rounded-md border border-white/20 px-5 py-2.5 text-sm font-medium text-white transition-all duration-200 hover:-translate-y-0.5 active:translate-y-0 hover:border-white/40 hover:bg-white/10"
            >
              Sign in
            </Link>
          </div>
